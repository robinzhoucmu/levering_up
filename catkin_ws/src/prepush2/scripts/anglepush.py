...
list_of_gripping_forces = [20]

# List of angles in degrees
list_of_angles = [-20,0,20]#,5,10,15,20,25,-25,-20,-15,-10,5]
...
position_and_ori_checking = False
            ...
            for push_velocity in list_of_velocities:
                    ...
                    for angle in list_of_angles:
                        ...
                        if position_and_ori_checking:
                                if not check_obj_init_pose():
                                        rospy.logerr("Initial position is NOT ok. Shutdown.")
                                        os.kill(os.getpid(), signal.SIGINT)
                                else:
